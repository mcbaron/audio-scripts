function ff_snr(infile, resultsfile)
# ff_snr.jl
# Fodor & Fingscheidt Reference-free SNR Measurement

# Implementation of the reference-free SNR measurement for narrow
# and wide-band Speech Signals in Car Noise

noisySpeech, fs = wavread(infile)
...
# Write out values
fpointer = open(resultsfile, "a")
write(fpointer, "$infile, $rawSNR, $trueSNR \n")

close(fpointer)

return [rawSNR, trueSNR]
